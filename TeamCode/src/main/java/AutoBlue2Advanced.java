...
@Autonomous(name="AutoBlue2Advanced", group="Auto")

public class AutoBlue2Advanced extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.driveForwardDistance(0.5,1000);
        ...
        robot.driveBackDistance(0.5, 200);
